...
- (id)initWithContentView:(UIView*)contentView
{
    ...
    if(self) {
        ...
        [self.layer setCornerRadius:contentView.frame.size.width/2];
        ...
        [contentView.layer setBorderColor:[UIColor clearColor].CGColor];
        [contentView.layer setBorderWidth:3.0];
...
- (void)computeOpenedSize
{
    ...
    CGFloat width = leftOffset + _baseButton.frame.size.width + leftOffset;
